...
///
/// Production voice-call presentation screen.
///
/// Responsibilities:
/// - Display caller identity.
/// - Display externally supplied call status.
/// - Display externally supplied call duration.
/// - Display externally supplied network quality.
/// - Forward end-call request to the parent/call layer.
...
/// - No fake security/encryption state.
///
...
class VoiceCallScreen extends StatefulWidget {
  ...
  /// Network-quality source supplied by NetworkManager / Provider.
...
class _VoiceCallScreenState extends State<VoiceCallScreen> {
  ...
  int get _safeInitialDuration {
    return widget.initialDurationSeconds
        .clamp(
      0,
    ...
    return Container(
      ...
      child: StreamBuilder<int>(
        ...
        builder: (
          ...
          final int seconds =
          (snapshot.data ?? _safeInitialDuration)
              .clamp(
            0,
            _maximumDurationSeconds,
          )
