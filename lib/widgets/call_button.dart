...
// - DTMF logic -> parent / WebRTC layer
...
class _CallBottomBarState extends State<CallBottomBar> {
  ...
  Future<void> _toggleMute() async {
    ...
    try {
      ...
      _reportError('Toggle microphone', error, stackTrace);
      _showError('Unable to change microphone state.');
    } finally {
      if (mounted) {
        setState(() {
          _muteLoading = false;
  ...
  Future<void> _toggleSpeaker() async {
    ...
    try {
      ...
      _showError('Unable to change speaker state.');
    } finally {
      if (mounted) {
        setState(() {
  ...
  Future<void> _toggleCamera() async {
    if (_cameraLoading || _endCallLoading || !widget.showVideoControls) {
      return;
    }
    ...
    try {
      ...
      _showError('Unable to change camera state.');
    } finally {
      if (mounted) {
        setState(() {
  ...
  void _endCall() {
    ...
    try {
      ...
      _showError('Unable to end the call.');
    }
  }
  ...
  Future<void> _openKeypad() async {
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        return _CallKeypadSheet(onDigitPressed: widget.onKeypadDigit);
      },
    );
  }
    ...
    return SafeArea(
      ...
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          final int controlCount = widget.showVideoControls ? 6 : 4;

          final double horizontalPadding = constraints.maxWidth < 360 ? 6 : 10;

          final double usableWidth =
              constraints.maxWidth - (horizontalPadding * 2);

          final double availablePerControl = usableWidth / controlCount;

          final double buttonSize = (availablePerControl - 7).clamp(42.0, 56.0);

          final double iconSize = buttonSize < 48 ? 21 : 24;
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: const Border(top: BorderSide(color: Color(0xFFDCE7F5))),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _CallControlButton(
                  tooltip: _isSpeakerEnabled ? 'Speaker off' : 'Speaker on',
                ...
                if (widget.showVideoControls) ...<Widget>[
                  _CallControlButton(
                    tooltip: _isCameraEnabled ? 'Camera off' : 'Camera on',
                    icon: _isCameraEnabled
                        ? Icons.videocam_rounded
                        : Icons.videocam_off_rounded,
                    foregroundColor: _isCameraEnabled
                        ? const Color(0xFF087AF5)
                        : const Color(0xFFE5484D),
                    selected: !_isCameraEnabled,
                  ...
                  _CallControlButton(
                    ...
                    foregroundColor: const Color(0xFF087AF5),
                    enabled: _isCameraEnabled,
                    loading: _switchCameraLoading,
                    size: buttonSize,
                    iconSize: iconSize,
                ...
                _CallControlButton(
                  ...
                  foregroundColor: const Color(0xFF00AFCB),
                  size: buttonSize,
                  iconSize: iconSize,
...
class _CallControlButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveBorder = backgroundColor != null
        ? backgroundColor!.withValues(alpha: 0.90)
        : selected
        ? foregroundColor.withValues(alpha: 0.30)
        : const Color(0xFFDCE7F5);

    final List<BoxShadow> shadows = backgroundColor != null
        ? const <BoxShadow>[
            BoxShadow(
          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                color: enabled ? effectiveBackground : const Color(0xFFF1F4F8),
                border: Border.all(
                  color: enabled ? effectiveBorder : const Color(0xFFE4E9F0),
                ),
...
class _CallKeypadSheet extends StatefulWidget {
  const _CallKeypadSheet({this.onDigitPressed});
...
class _CallKeypadSheetState extends State<_CallKeypadSheet> {
  ...
  void _append(String value) {
    ...
    widget.onDigitPressed?.call(value);
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              height: 4,
              decoration: BoxDecoration(
                color: const Color(0xFF98A2B3).withValues(alpha: 0.40),
            ...
            const Row(
              ...
              children: <Widget>[
                Icon(Icons.dialpad_rounded, color: Color(0xFF087AF5), size: 20),
                SizedBox(width: 8),
                Text(
                  'Keypad',
                  style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: Text(
                      _input.isEmpty ? 'Enter digits' : _input,
                      maxLines: 1,
                      ...
                      style: TextStyle(
                        color: _input.isEmpty
                            ? const Color(0xFF98A2B3)
                            : const Color(0xFF087AF5),
                        fontSize: _input.isEmpty ? 16 : 27,
                        fontWeight: FontWeight.w700,
                        letterSpacing: _input.isEmpty ? 0 : 2,
                      ),
                    ),
                  ),
            ...
            _buildRow(const <String>['1', '2', '3']),

            const SizedBox(height: 14),

            _buildRow(const <String>['4', '5', '6']),

            const SizedBox(height: 14),

            _buildRow(const <String>['7', '8', '9']),

            const SizedBox(height: 14),

            _buildRow(const <String>['*', '0', '#']),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                ...
                colors: <Color>[Color(0xFFFFFFFF), Color(0xFFF2F8FF)],
              ),
              border: Border.all(color: const Color(0xFFDCE7F5)),
              boxShadow: const <BoxShadow>[
                BoxShadow(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: const <BoxShadow>[
                  BoxShadow(
                    color: Color(0x14FF4D5E),
                    blurRadius: 12,
                    offset: Offset(0, 4),
                  ),
                ],
              ),
              child: Icon(icon, color: const Color(0xFFFF4D5E), size: 23),
            ),
          ),
        ),
      ),
