...
class JRCallIncomingMessageReceiver :
    ...
    override fun onMessageReceived(
        ...
        /*
         * Preserve FlutterFire delivery first so existing Dart
         * foreground/background FCM routing continues to work.
         */
    ...
    private fun presentIncomingCall(
        ...
        return try {
            ...
            Log.e(
                TAG,
                "Unable to post incoming call notification.",
                error
            )
    ...
    private fun savePendingCall(
        ...
        json.put("isVideoCall", isVideoCall)
